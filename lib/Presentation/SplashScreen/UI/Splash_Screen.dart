...
class Splash_Screen extends StatelessWidget {
  ...
  // ignore: non_constant_identifier_names
  late Button_Draage button_draage = Button_Draage(icons: 0);
            ...
            children: <Widget>[
              ...
              Pinned.fromPins(
                context.locale == const Locale('en')
                    ? Pin(
                        start: Width > Hieght ? Width * 0.1 : Width * 0.17,
                        end: -45.0)
                    : Pin(
                        start: -45.0,
                        end: Width > Hieght ? Width * 0.1 : Width * 0.17),
              ...
              Pinned.fromPins(
                  Pin(size: 50.0, start: 40.0), Pin(size: 50.0, end: 26.0),
              ...
              Pinned.fromPins(
                context.locale == const Locale('en')
                    ...
                    : Pin(
                        start: 37.0,
                        end: Width > Hieght ? Width * 0.36 : Width * 0.2),
