      ...
      height: size.height,
        ...
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 35.5, start: size.height * 0.2),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: size.width * 0.7, start: 31.5),
          ...
          Align(
            alignment: Alignment(0.003, 0.42),
            child: SizedBox(
              width: 95.0,
              height: 110.0,
              child: PageLink(
                    ...
                    Pinned.fromPins(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          fontSize: (size.height + size.width) * 0.015,
                  ...
                  pageBuilder: () {
                    if(read.text.isNotEmpty){
                      ...
                      for(int i = 0; i< list_text.length;i++){
                        list_map.add({"Name":list_text[i],"type":"2"});
                      }
                      return read_page(text_read: list_map);
                    }else{
                      return read_page(text_read: [{"Name":"Hello","type":"3"}],);
                    }
                  },
                ),
              ],
